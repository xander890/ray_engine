...
public:
	...
	void initialize_mesh(Geometry& object) override;
	void pre_trace_mesh(Geometry& object) override;
	void post_trace_mesh(Geometry& object) override;
	bool on_draw() override;
	Shader* clone() override { return new HemisphereBSSRDFShader(*this); }
	void load_data(Geometry & object) override;
