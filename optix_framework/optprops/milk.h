...
struct OPTPROPS_API LogNormalParticleDistrib : public LorenzMie::ParticleDistrib
{
  double r_vs;  // volume-to-surface mean particle radius
  double c_s;   // particle radius standard deviation
};

OPTPROPS_API Medium milk(LogNormalParticleDistrib& fat,     // Distribution of fat globules
...
OPTPROPS_API Medium milk(double fat_weight,                 // milk fat weight-%
            double protein_weight = 3.4,       // protein weight-%
...
OPTPROPS_API Medium homogenized_milk(double fat_weight,            // milk fat weight-%
                        double protein_weight = 3.4,  // protein weight-%
                        double pressure = 0.0,        // Homogenization pressure
                        double casein_r_vs = 43.0e-9, // volume-to-surface mean radius of casein micelles
                        double casein_c_s = 0.23);    // radius standard deviation of casein micelles

OPTPROPS_API Medium unhomogenized_milk(double fat_weight,            // milk fat weight-%
                          double protein_weight = 3.4,  // protein weight-%
                          double casein_r_vs = 43.0e-9, // volume-to-surface mean radius of casein micelles
                          double casein_c_s = 0.23);    // radius standard deviation of casein micelles
