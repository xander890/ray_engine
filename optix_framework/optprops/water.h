...
Medium OPTPROPS_API water(double temperature = 22.0, // Temperature in degrees celcius 
             double salinity = 0.0);    // Salinity in parts per thousand

// Empirical formula of Quan and Fry 1995.
double OPTPROPS_API water_ior_real_part(double wavelength,  // Wavelength in nanometers
