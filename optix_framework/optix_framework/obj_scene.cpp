...
void ObjScene::initScene(GLFWwindow * window, InitialCameraData& init_camera_data)
{
    ...
    auto camera_type = PinholeCameraDefinitionType::String2Enum(ConfigParameters::get_parameter<string>("camera", "camera_definition_type", PinholeCameraDefinitionType::Enum2String(PinholeCameraDefinitionType::EYE_LOOKAT_UP_VECTORS), "Type of the camera."));
	...
	current_miss_program = BackgroundType::String2Enum(ConfigParameters::get_parameter<string>("config", "default_miss_type", BackgroundType::Enum2String(BackgroundType::CONSTANT_BACKGROUND), "Default miss program."));
    ...
    RenderingMethodType::EnumType t = RenderingMethodType::String2Enum(ConfigParameters::get_parameter<string>("config", "rendering_type", RenderingMethodType::Enum2String(RenderingMethodType::RECURSIVE_RAY_TRACING), "Rendering method"));
...
void ObjScene::add_lights(vector<TriangleLight>& area_lights)
{
    ...
    LightTypes::EnumType default_light_type = LightTypes::String2Enum(ConfigParameters::get_parameter<string>("light", "default_light_type", LightTypes::Enum2String(LightTypes::DIRECTIONAL_LIGHT), "Type of the default light"));
