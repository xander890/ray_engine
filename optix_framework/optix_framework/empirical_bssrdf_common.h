...
#define IMPROVED_ENUM_LIST	ENUMITEM_VALUE(UNCHANGED,0) \
							ENUMITEM_VALUE(NO_ONLY,1) \
							ENUMITEM_VALUE(NI_ONLY,2) \
							ENUMITEM_VALUE(MODIFIED_TANGENT_PLANE,3) \
							ENUMITEM_VALUE(MODIFIED_TANGENT_PLANE_ALL,4) \
