...
#define IMPROVED_ENUM_LIST	ENUMITEM(STANDARD_DIPOLE_BSSRDF) \
							ENUMITEM(DIRECTIONAL_DIPOLE_BSSRDF) \
							ENUMITEM(APPROX_STANDARD_DIPOLE_BSSRDF) \
							ENUMITEM(APPROX_DIRECTIONAL_DIPOLE_BSSRDF) 
